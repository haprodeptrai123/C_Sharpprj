...
{
    public partial class frmBaby : Form
    {
        public frmBaby()
        {
            InitializeComponent();
        ...
        private void frmBaby_Load(object sender, EventArgs e)
        {
            conn.Open();

            #region Create a SqlCommand object and execute stored procedures
            //SqlCommand com = new SqlCommand("sp_Select_Baby", conn);
            //com.CommandType = CommandType.StoredProcedure;

            SqlCommand com = new SqlCommand();
            com.Connection = conn;
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "sp_Select_Baby";
            #endregion
