...
namespace ProjManagement
{
    public partial class frmRetirement : Form
    {
        ...
        private void frmRetirement_Load(object sender, EventArgs e)
        {
            ...
            //SqlCommand com = new SqlCommand("sp_Select_Retirement", conn);
            //com.CommandType = CommandType.StoredProcedure;

            SqlCommand com = new SqlCommand();
            com.Connection = conn;
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "sp_Select_Retirement";
            #endregion
            ...
            while (dr.Read())
            {
                ...
                LivRetirement.Items[i].SubItems.Add(dr["empBirthDate"].ToString());
                LivRetirement.Items[i].SubItems.Add(dr["empSex"].ToString());
